...
function KeyGate({ onUnlock }: { onUnlock: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4"
      ...
      >
        {/* Logo */}
        <img src={LOGO} alt="The Bead Basket" className="h-20 w-20 object-contain mx-auto mb-2" />
        <div className="font-display text-2xl font-semibold">The Bead Basket</div>
      ...
      <header className="sticky top-0 z-40 border-b border-border/50 bg-cream/92 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-3">
          <div className="flex items-center gap-3">
            <img src={LOGO} alt="The Bead Basket" className="h-11 w-11 object-contain" />
            <div>
              <p className="font-display text-base leading-tight font-semibold">The Bead Basket</p>
